...
public class MultiMap<K, V> implements Serializable {
  ...
  /**
   * Adds all entries in given {@link List} to this {@link MultiMap} with key.
   */
   ...
   */
  public List<K> keys() {
    return new ArrayList<>(this.mInternalMap.keySet());
  }
  ...
  public List<Map.Entry<K, V>> entries() {
    List<Map.Entry<K, V>> entryList = new ArrayList<>(size());
    for (K key : keys()) {
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof MultiMap) {
      ...
      for (K key : this.mInternalMap.keySet()) {
  ...
  public MultiMap<K, V> createImmutableClone() {
    return new MultiMap<>(Collections.unmodifiableMap(this.mInternalMap));
  }
}